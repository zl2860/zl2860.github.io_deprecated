...
[[CV]](./LIU, ZONGCHAO_07/20/2020.pdf)
...
1. Controlling FDR: A 3D-based interpretable deep learning model for diffusion tensor brain imaging data
https://github.com/zl2860/3d-CNN-DTI
![](./dl_dashoboard.png)

2. Radiomics analysis of computed tomography for predicting pathological response to neoadjuvant treatment in rectal cancer: Post-hoc Analysis of a Randomized Controlled Trial
